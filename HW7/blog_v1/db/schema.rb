...
ActiveRecord::Schema[7.0].define(version: 20_221_205_082_438) do
  ...
  create_table 'likes', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[author_id likeable_type likeable_id],
            name: 'index_likes_on_author_id_and_likeable_type_and_likeable_id', unique: true
